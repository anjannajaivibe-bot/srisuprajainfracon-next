...
const ProjectHero = ({ project }: ProjectHeroProps) => {
  return (
    <section className="relative overflow-hidden bg-[#F8F6F1] pt-28">
      <div className="absolute inset-x-0 top-0 h-[420px] bg-gradient-to-br from-[#081225] via-[#0B1633] to-[#18345F]" />
      ...
      <div className="container-max relative z-10 px-4 pb-20 sm:px-6 lg:px-8">
        ...
        <motion.h1
          ...
          className="mb-10 max-w-6xl text-4xl font-display font-bold leading-[1.03] tracking-tight text-white sm:text-5xl lg:text-7xl"
        >
          {project.title}
        </motion.h1>
        ...
        <div className="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-stretch">
          ...
          >
            ...
            <SmartImage
              ...
              alt={`${project.title} project by Sri Supraja Infracon`}
              priority
