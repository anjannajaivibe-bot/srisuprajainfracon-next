export const projectContent = {
  "supraja-iris-resort-plots": {
    ...
    amenities: [
      ...
      "Underground sewerage with septic tank",
      "100% Vastu compliant plots",
      "Children play area",
      "Landscaped parks and jogging tracks",
      "Grand entrance arch",
      "Lush green avenue plantation",
    ...
    locationAdvantages: [
      ...
      "High ROI growth corridor near Hyderabad",
    ],
    ...
    faq: [
      {
        question: "Is Supraja IRIS DTCP & RERA approved?",
        answer:
          "Yes. Supraja IRIS is a DTCP & RERA approved resort-style open plot development at Kamkole.",
      },
      {
  ...
  "bridge-county": {
    ...
    amenities: [
      ...
      "50 and 33 feet black top roads",
      "Underground electricity with street lighting",
      "Water connection to each plot",
      ...
      "Children play area",
      "Grand entrance arch",
      "Protected compound boundaries",
      "Landscaped parks",
      "Lush green avenue plantation",
      "Jogging track",
      "Overhead water tank",
      "Footpaths with kerb stones",
      "Rainwater harvesting pits",
      "Bank loan assistance available",
    ],
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Yes. Bridge County is registered under RERA No. P01100009141.",
      },
      {
  ...
  "sindhu-sarovar": {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Plots are planned from 150 square yards to 569 square yards, subject to current availability.",
      },
      {
        question: "Are Sindhu Sarovar bookings open?",
        answer:
          "Yes. Open plot sales are currently open for selected plot options.",
      },
    ],
  },
  ...
  "subhash-meadows": {
    ...
    amenities: [
      ...
      "Open space for common amenities",
      "Parks and landscaping",
      "Arch and gated entrance",
      "Security room provision",
      "Planned community infrastructure",
    ],

    locationAdvantages: [
      "Located at Indrakaran",
